...
public class EarthquakeCityMap extends PApplet {
	 ...
	 */
	private void hideMarkers(Marker refMarker) {                // we add this function
		for (Marker marker: quakeMarkers) {
	 ...
	 * 		   fale otherwise
	 */
	private boolean isThreatened(CityMarker marker, EarthquakeMarker threat) {           // we add this function
	 ...
	 * 		   false otherwise
	 */
	private boolean isThreat(EarthquakeMarker threat, CityMarker marker) {              // we add this function
		double distance = threat.threatCircle();
